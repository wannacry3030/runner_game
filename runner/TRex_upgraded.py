...
sky_surface_1 = pygame.image.load('Images/JurassicSky2.png').convert()
sky_surface_frames = [sky_surface, sky_surface_1]
sky_surface_frames_index = 0
sky_surface_surf = sky_surface_frames[sky_surface_frames_index]
...
game_message = test_font.render('Aperte ESPACO', False, (111,196,169))
...
pygame.time.set_timer(sky_animation_timer, 200)
...
while True:
    ...
    # Alterna entre as imagens do céu
                if sky_surface_frames_index == 0:
                     sky_surface_frames_index = 1
                else:
                    sky_surface_frames_index = 0
                sky_surface_surf = sky_surface_frames[sky_surface_frames_index]

    if game_active:   
        screen.blit(sky_surface_surf, (0, 0))
